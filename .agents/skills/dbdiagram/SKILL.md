---
name: dbdiagram
description: Thiết kế database schema chi tiết bằng DBML (database markup language), xuất SQL và kiểm tra cú pháp bằng dbml2sql để bàn giao schema chuẩn cho nhà phát triển.
---

### Cách gọi
Kích hoạt hoặc yêu cầu vẽ sơ đồ bằng ngôn ngữ tự nhiên, ví dụ:
- `@dbdiagram [--feature <slug>]`
- Hoặc yêu cầu: "vẽ sơ đồ dbdiagram cho..."
...
- [example-dbdiagram.dbml](file:///C:/Code/PRM/PRM-SE1902-Project-CSCM/.agents/skills/dbdiagram/references/example-dbdiagram.dbml) (mẫu chuẩn đã validate qua dbml2sql)
