---
name: erd
description: Vẽ sơ đồ quan hệ thực thể (ERD) bằng Mermaid thể hiện các thực thể, thuộc tính và mối quan hệ cardinality (1:1, 1:N, N:N) nhúng inline trong tài liệu markdown.
---

### Cách gọi
Kích hoạt hoặc yêu cầu vẽ sơ đồ bằng ngôn ngữ tự nhiên, ví dụ:
- `@erd [--feature <slug>]`
- Hoặc yêu cầu: "vẽ sơ đồ erd cho..."
...
- [example-erd.md](file:///C:/Code/PRM/PRM-SE1902-Project-CSCM/.agents/skills/erd/references/example-erd.md)
